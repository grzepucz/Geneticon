    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=30)),
                ('size', models.BigIntegerField(default=0)),
                ('create_date', models.DateField(default=datetime.datetime(2020, 11, 11, 11, 39, 54, 140690))),
            ],
        ),
        migrations.CreateModel(
            name='Selection',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=30)),
                ('epoch', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='geneticon.epoch')),
        ...
        migrations.AddField(
            model_name='epoch',
            name='life',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='geneticon.life'),
        ),
        migrations.AddField(
